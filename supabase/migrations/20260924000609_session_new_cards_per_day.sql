-- get_study_session agregaba p_new_limit palabras nuevas en CADA llamada:
-- recargar la página sumaba 5 palabras más. Ahora descuenta las ya
-- introducidas hoy (día UTC).
